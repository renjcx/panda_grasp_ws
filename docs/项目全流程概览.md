...
过程中解决了 3 个 MoveItPy 兼容性 bug（参数名不匹配、规划管线加载失败、仿真时间下轨迹执行失败，详见 [`moveitpy_bug_fixes.md`](moveitpy_bug_fixes.md)）和 1 个 Gazebo 资源路径问题，踩坑过程已沉淀到 [`gazebo_troubleshooting.md`](gazebo_troubleshooting.md)。
